...
class Action {
    ...
    _pushPackage(version, name) {
        ...
        this._executeInProcess(`dotnet pack ${this.includeSymbols ? "--include-symbols -p:SymbolPackageFormat=snupkg" : ""} -p:PackageVersion=${this.version} --no-build -c Release ${this.projectFile} -o .`)
    ...
    run() {
        ...
        this.version += this.versionSuffix
